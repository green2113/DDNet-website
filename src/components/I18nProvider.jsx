...
const translations = {
  ...
  ko: {
    ...
    dashboard: {
      ...
      gameCodeBody: '보안상 현재 코드는 표시하지 않습니다.',
      rotate: '새 코드 발급',
      rotating: '발급 중...',
  ...
  en: {
    ...
    dashboard: {
      ...
      gameCodeBody: 'Current code is hidden for security.',
      rotate: 'Rotate Code',
      rotating: 'Rotating...',
  ...
  ja: {
    ...
    dashboard: {
      ...
      gameCodeBody: 'セキュリティ上、現在のコードは表示しません。',
      rotate: '新しいコードを発行',
      rotating: '発行中...',
