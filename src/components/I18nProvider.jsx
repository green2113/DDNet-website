...
const translations = {
  ...
  ko: {
    ...
    register: {
      ...
      name: '이름',
      nameHint: 'DDNet에서 사용할 이름을 적어주세요.',
      email: '이메일',
      password: '비밀번호',
  ...
  en: {
    ...
    home: {
      ...
      eyebrow: 'DDNET COMMUNITY',
      title: 'A cleaner DDNet community server',
    ...
    register: {
      ...
      name: 'Name',
      nameHint: 'Enter the name you will use in DDNet.',
      email: 'Email',
      password: 'Password',
